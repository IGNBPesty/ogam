...
ALTER TABLE application_process
 DROP CONSTRAINT FK_application;

ALTER TABLE field
 DROP CONSTRAINT FK_attribute;

ALTER TABLE process_check
 DROP CONSTRAINT FK_check;
...
ALTER TABLE class_tree
 DROP CONSTRAINT FK_class2;

ALTER TABLE code_tree
 DROP CONSTRAINT FK_code;

ALTER TABLE code_taxref
 DROP CONSTRAINT FK_code_tree;

ALTER TABLE code_set
 DROP CONSTRAINT FK_code1;

ALTER TABLE code_set
 DROP CONSTRAINT FK_code2;

ALTER TABLE code_composition
 DROP CONSTRAINT FK_code3;

ALTER TABLE code_composition
 DROP CONSTRAINT FK_code4;

ALTER TABLE code_composition
 DROP CONSTRAINT FK_code5;

ALTER TABLE db_table_column
 DROP CONSTRAINT FK_component;

ALTER TABLE file_column
 DROP CONSTRAINT FK_component1;

ALTER TABLE ui_field
 DROP CONSTRAINT FK_component2;

ALTER TABLE component_mapping_method
 DROP CONSTRAINT FK_component3;

ALTER TABLE component
 DROP CONSTRAINT FK_container;

ALTER TABLE db_table_relation
 DROP CONSTRAINT FK_container_relation;

ALTER TABLE ui_container_tree
 DROP CONSTRAINT FK_container_relation1;

ALTER TABLE file_container
 DROP CONSTRAINT FK_container1;

ALTER TABLE db_container
 DROP CONSTRAINT FK_container2;

ALTER TABLE ui_object
 DROP CONSTRAINT FK_container3;

ALTER TABLE container_relation
 DROP CONSTRAINT FK_container4;

ALTER TABLE container_relation
 DROP CONSTRAINT FK_container5;

ALTER TABLE process_container
 DROP CONSTRAINT FK_container6;

ALTER TABLE field_context
 DROP CONSTRAINT FK_context;

ALTER TABLE lot_context
 DROP CONSTRAINT FK_context1;

ALTER TABLE context_value
 DROP CONSTRAINT FK_context2;

ALTER TABLE context_code
 DROP CONSTRAINT FK_context3;

ALTER TABLE db_table
 DROP CONSTRAINT FK_db_container;

ALTER TABLE db_table_relation
 DROP CONSTRAINT FK_db_table;

ALTER TABLE file_column
 DROP CONSTRAINT FK_db_table_column;

ALTER TABLE ui_field
 DROP CONSTRAINT FK_db_table_column1;

ALTER TABLE db_table_relation
 DROP CONSTRAINT FK_db_table1;

ALTER TABLE db_table_column
 DROP CONSTRAINT FK_field;

ALTER TABLE field_context
 DROP CONSTRAINT FK_field1;

ALTER TABLE process
 DROP CONSTRAINT FK_lot;

ALTER TABLE field
 DROP CONSTRAINT FK_lot1;

ALTER TABLE lot_context
 DROP CONSTRAINT FK_lot2;

ALTER TABLE lot_set
 DROP CONSTRAINT FK_lot3;

ALTER TABLE lot_set
 DROP CONSTRAINT FK_lot4;

ALTER TABLE component_mapping_method
 DROP CONSTRAINT FK_mapping_method;

ALTER TABLE context_code
 DROP CONSTRAINT FK_mode;

ALTER TABLE application_process
 DROP CONSTRAINT FK_process;

ALTER TABLE process_check
 DROP CONSTRAINT FK_process1;

ALTER TABLE process_container
 DROP CONSTRAINT FK_process2;

ALTER TABLE ui_form_field
 DROP CONSTRAINT FK_ui_field;

ALTER TABLE ui_request_field
 DROP CONSTRAINT FK_ui_field1;

ALTER TABLE field
 DROP CONSTRAINT FK_unit;

ALTER TABLE code
 DROP CONSTRAINT FK_unit1;

ALTER TABLE code_sql
 DROP CONSTRAINT FK_unit2;

ALTER TABLE unit_constraint
 DROP CONSTRAINT FK_unit3;
