...
(
    ...
    component CHARACTER VARYING(32) NOT NULL,
    type CHARACTER VARYING(32) NOT NULL,
    method CHARACTER VARYING(32) NULL
);


CREATE TABLE component_relation_method 
(
...
CREATE TABLE process_relation_set 
(
    process CHARACTER VARYING(32) NOT NULL,
    container_relation_set CHARACTER VARYING(32) NOT NULL,
    component_relation_set CHARACTER VARYING(32) NOT NULL,
    type CHARACTER VARYING(32) NOT NULL
);


CREATE TABLE relation_entry_component 
(
    entry_component CHARACTER VARYING(32) NOT NULL,
    component CHARACTER VARYING(32) NOT NULL,
    relation_set CHARACTER VARYING(32) NOT NULL,
    type CHARACTER VARYING(32) NOT NULL
);
...
ALTER TABLE component 
  ADD CONSTRAINT component_pk PRIMARY KEY (
    component)  ;
ALTER TABLE component_relation_method 
  ADD CONSTRAINT component_relation_method_pk PRIMARY KEY (
    method)  ;
ALTER TABLE component_relation 
  ADD CONSTRAINT component_relation_pk PRIMARY KEY (
    component, relation_set, type)  ;
...
ALTER TABLE process_relation_set 
  ADD CONSTRAINT process_relation_set_pk PRIMARY KEY (
    process, container_relation_set, component_relation_set)  ;
ALTER TABLE relation_entry_component 
  ADD CONSTRAINT relation_entry_component_pk PRIMARY KEY (
    entry_component, component, relation_set, type)  ;
ALTER TABLE relation_set 
  ADD CONSTRAINT relation_set_pk PRIMARY KEY (
    relation_set)  ;
