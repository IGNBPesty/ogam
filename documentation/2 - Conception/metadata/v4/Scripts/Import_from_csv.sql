...
ALTER TABLE relation_entry_component DROP CONSTRAINT FK_component_relation;
ALTER TABLE file_column DROP CONSTRAINT FK_component1;
ALTER TABLE ui_field DROP CONSTRAINT FK_component2;
ALTER TABLE component_relation DROP CONSTRAINT FK_component3;
ALTER TABLE relation_entry_component DROP CONSTRAINT FK_component4;
...
ALTER TABLE ui_object_tree DROP CONSTRAINT FK_container_relation2;
...
ALTER TABLE component DROP CONSTRAINT FK_field;
...
ALTER TABLE component_relation DROP CONSTRAINT FK_mapping_method;
...
ALTER TABLE process_relation_set DROP CONSTRAINT FK_process2;
ALTER TABLE process_relation_set DROP CONSTRAINT FK_relation_set;
ALTER TABLE process_relation_set DROP CONSTRAINT FK_relation_set1;
ALTER TABLE component_relation DROP CONSTRAINT FK_relation_set2;
ALTER TABLE container_relation DROP CONSTRAINT FK_relation_set3;
...
DELETE FROM "check" where "check" <= 1200;
DELETE FROM "class";
...
DELETE FROM component_relation;
DELETE FROM component_relation_method;
...
DELETE FROM process_relation_set;
DELETE FROM relation_entry_component;
DELETE FROM relation_set;
DELETE FROM "translation";
DELETE FROM ui_container_tree;
DELETE FROM ui_field;
DELETE FROM ui_form_field;
DELETE FROM ui_object;
DELETE FROM ui_object_tree;
...
COPY "check" from 'D:/DONNEES/Workspace/OGAM/documentation/2 - Conception/metadata/v4/check.csv' with delimiter ';' null '';
...
COPY component_relation from 'D:/DONNEES/Workspace/OGAM/documentation/2 - Conception/metadata/v4/component_relation.csv' with delimiter ';' null '';
--COPY component_relation_method from 'D:/DONNEES/Workspace/OGAM/documentation/2 - Conception/metadata/v4/component_relation_method.csv' with delimiter ';' null '';
...
COPY process_relation_set from 'D:/DONNEES/Workspace/OGAM/documentation/2 - Conception/metadata/v4/process_relation_set.csv' with delimiter ';' null '';
COPY relation_entry_component from 'D:/DONNEES/Workspace/OGAM/documentation/2 - Conception/metadata/v4/relation_entry_component.csv' with delimiter ';' null '';
COPY relation_set from 'D:/DONNEES/Workspace/OGAM/documentation/2 - Conception/metadata/v4/relation_set.csv' with delimiter ';' null '';
...
COPY ui_object_tree from 'D:/DONNEES/Workspace/OGAM/documentation/2 - Conception/metadata/v4/ui_object_tree.csv' with delimiter ';' null '';
...
UPDATE metadata.translation t
 ...
 WHERE t.db_table = t2.db_table and t.row_pk = t2.row_pk and t.lang = 'EN' and t2.lang = 'FR' and t.label is null;

 UPDATE metadata.translation t
   SET definition= 'EN...' || t2.definition
   FROM metadata.translation t2
 WHERE t.db_table = t2.db_table and t.row_pk = t2.row_pk and t.lang = 'EN' and t2.lang = 'FR' and t.definition is null;
...
ALTER TABLE relation_entry_component
  ADD CONSTRAINT FK_component_relation 
    FOREIGN KEY (component, relation_set, type)
      REFERENCES component_relation;
...
ALTER TABLE component_relation
  ADD CONSTRAINT FK_component3 
    FOREIGN KEY (component)
      REFERENCES component;

ALTER TABLE relation_entry_component
  ADD CONSTRAINT FK_component4 
    FOREIGN KEY (entry_component)
      REFERENCES component;
...
ALTER TABLE component_relation
  ADD CONSTRAINT FK_mapping_method 
    FOREIGN KEY (method)
      REFERENCES component_relation_method;
...
ALTER TABLE process_relation_set
  ADD CONSTRAINT FK_process2 
    FOREIGN KEY (process)
      REFERENCES process;

ALTER TABLE process_relation_set
  ADD CONSTRAINT FK_relation_set 
    FOREIGN KEY (container_relation_set)
      REFERENCES relation_set;

ALTER TABLE process_relation_set
  ADD CONSTRAINT FK_relation_set1 
    FOREIGN KEY (component_relation_set)
      REFERENCES relation_set;

ALTER TABLE component_relation
  ADD CONSTRAINT FK_relation_set2 
    FOREIGN KEY (relation_set)
      REFERENCES relation_set;

ALTER TABLE container_relation
  ADD CONSTRAINT FK_relation_set3 
    FOREIGN KEY (relation_set)
      REFERENCES relation_set;
